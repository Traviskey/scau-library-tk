<template>
  <div class="search_container">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>分类查看</el-breadcrumb-item>
    </el-breadcrumb>
        ...
        >分类选择:
          ...
          >
            <el-option
                ...
                :key="item.records.type"
                :label="item.records.type"
                :value="item.records.type"
            >
            </el-option>
          </el-select>
        </el-col>
      ...
      >
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button
                size="mini"
                @click="handleCart(scope.row)">购物车</el-button>
            <el-button
                size="mini"
                type="danger"
                @click="handleCollect(scope.row)">收藏</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页查询区域 -->
...
export default {
  ...
  methods: {
    ...
    handleCart(row){
      ...
      this.CartInfo.bookName = bookName;
      this.CartInfo.bookNumber = bookNumber;
      this.CartInfo.userId = id;
      this.handleCartById();
    },
    handleCollect(row){
      const {bookName,bookNumber} = row;
      ...
      this.CollectInfo.bookName = bookName;
      this.CollectInfo.bookNumber = bookNumber;
      this.CollectInfo.userId = id;
      this.handleCollectById();
    },
    async handleCartById() {
      this.loading = true;
