  ...
  <div class="search_container">
    ...
    <el-card shadow="always">
      ...
      v-loading="loading"
        ...
        <el-table-column prop="bookTypeNumber" label="ID" sortable> </el-table-column>
        <el-table-column prop="bookType" label="分类名"> </el-table-column>
        <el-table-column prop="bookTypeDescription" label="描述"> </el-table-column>
          ...
          <template slot-scope="scope">
            ...
            >
              <el-button
                ...
                icon="el-icon-delete"
                size="mini"
                @click="removeUserById(scope.row.bookTypeNumber)"
              ></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      ...
      >
        <el-form
          ...
          label-width="120px"
        >
          <el-form-item label="分类名" prop="bookType">
            <el-input v-model="addForm.bookType"></el-input>
          </el-form-item>
          <el-form-item label="分类描述" prop="bookTypeDescription">
            <el-input v-model="addForm.bookTypeDescription" type="textarea"></el-input>
          </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    async removeUserById(id) {
      ...
      const {data:res } = await this.$http.get('admin/delete_booktype/'+typeId);
      if (res.status !== 200) {
        return this.$message.error(res.msg);
      }
