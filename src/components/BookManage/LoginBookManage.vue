  ...
  <div class="login_container">
    ...
    <div class="login_box">
      ...
      <div class="avatar_box">
        <img
          src="https://ts1.cn.mm.bing.net/th?id=OIP-C.Ga85-YnEEWvrZhEx6As-ZQHaG9&w=218&h=206&c=8&rs=1&qlt=90&o=6&dpr=2&pid=3.1&rm=2"
          alt=""
        />
      </div>
      <!-- 登录表单区域 -->
...
.login_container {
  ...
  background: url(https://ts1.cn.mm.bing.net/th?id=OIP-C.FxG24uhqqVrxueN2IvnjFAHaE8&w=157&h=105&c=8&rs=1&qlt=90&o=6&dpr=2&pid=3.1&rm=2) no-repeat
    0px 0px;
