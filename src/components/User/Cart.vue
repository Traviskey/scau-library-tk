        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <el-button
                size="mini"
                type="danger"
                @click="handleOrder(scope.row)">下单</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页查询区域 -->
...
export default {
  ...
  methods: {
    ...
    handleOrder(row){
      ...
      const stringId = window.sessionStorage.getItem("userId");
      const id = parseInt(stringId);
      const cardName = window.sessionStorage.getItem("cardName");
      const address = window.sessionStorage.getItem("address");

      this.OrderInfo.userId = id;
      this.OrderInfo.bookName = bookName;
      this.OrderInfo.cardName = cardName;
      this.OrderInfo.address = address;
      this.handleOrderById();
    },
