<template>
  <div class="search_container">
    ...
    <el-card shadow="always">
      ...
      <el-row :gutter="10">
        <el-col :span="6">条件搜索:
          <el-select v-model="queryInfo.condition" filterable placeholder="请选择"
      ...
      <el-table :data="tableData" border height="520" style="width: 100%" stripe id="pdfDom"
                :default-sort="{ prop: 'bookNumber', order: 'ascending' }" v-loading="loading"
          ...
          <template slot-scope="scope">
            ...
            <el-tooltip effect="dark" content="修改" placement="top" :enterable="false">
              <el-button type="primary" icon="el-icon-edit" size="mini"
                         @click="showEditDialog(scope.row.bookId)"></el-button>
            </el-tooltip>
      ...
      <!-- 修改规则的对话框 -->
      <el-dialog title="修改书籍(若信息不变，请原样填写)" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed">
        <el-form :model="editForm" ref="editFormRef" :rules="editFormRules" label-width="120px">
          ...
          <el-form-item label="分类">
            <el-select v-model="editForm.bookType" placeholder="请选择">
              <el-option v-for="item in types" :key="item.bookType" :label="item.bookType" :value="item.bookType">
              </el-option>
            </el-select>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async showEditDialog(id) {
      ...
      this.editForm.bookNumber = parseInt(id);
    },
    ...
    async removeUserById(id) {
      ...
      const {data: res} = await this.$http.get("admin/delete_book/" + bookId);
      // console.log(res);
      if (res.status !== 200) {
